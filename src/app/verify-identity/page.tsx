    ...
    <main style={{ minHeight: '100vh', background: '#111', color: '#e0e0e0', padding: '16px' }}>
      <div style={{ maxWidth: '500px', margin: '0 auto' }}>
        ...
        <section style={{ background: '#1a1a1a', border: '0.5px solid #2a2a2a', borderRadius: '16px', padding: '20px' }}>
          ...
          {isVerified && <p role="status" style={{ color: '#6dba6d', fontSize: '14px', lineHeight: 1.5 }}>✓ Your identity is verified. You can use Driver mode.</p>}
          ...
          {isVerified && <button type="button" onClick={() => router.push('/feed')} style={{ width: '100%', marginTop: '12px', border: 0, borderRadius: '10px', padding: '13px', background: '#c8b86a', color: '#111', fontWeight: '700', cursor: 'pointer' }}>CONTINUE TO DRIVER MODE</button>}
